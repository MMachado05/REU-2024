...
wget -q https://bitbucket.org/DataspeedInc/dbw_polaris_ros/raw/master/dbw_polaris/scripts/joystick_demo.desktop -O $HOME/.config/autostart/joystick_demo.desktop
