...
MsgPosEcefGnss convertSbpMsgToRosMsg(const msg_pos_ecef_gnss_t& sbp_msg, const uint8_t len)
{
  MsgPosEcefGnss ros_msg;
  ros_msg.tow = sbp_msg.tow;
  ros_msg.x = sbp_msg.x;
  ros_msg.y = sbp_msg.y;
  ros_msg.z = sbp_msg.z;
...
MsgPosEcefCovGnss convertSbpMsgToRosMsg(const msg_pos_ecef_cov_gnss_t& sbp_msg, const uint8_t len)
{
  MsgPosEcefCovGnss ros_msg;
  ros_msg.tow = sbp_msg.tow;
  ros_msg.x = sbp_msg.x;
  ros_msg.y = sbp_msg.y;
  ros_msg.z = sbp_msg.z;
...
MsgPosLlhGnss convertSbpMsgToRosMsg(const msg_pos_llh_gnss_t& sbp_msg, const uint8_t len)
{
  MsgPosLlhGnss ros_msg;
  ros_msg.tow = sbp_msg.tow;
  ros_msg.lat = sbp_msg.lat;
  ros_msg.lon = sbp_msg.lon;
  ros_msg.height = sbp_msg.height;
...
MsgPosLlhCovGnss convertSbpMsgToRosMsg(const msg_pos_llh_cov_gnss_t& sbp_msg, const uint8_t len)
{
  MsgPosLlhCovGnss ros_msg;
  ros_msg.tow = sbp_msg.tow;
  ros_msg.lat = sbp_msg.lat;
  ros_msg.lon = sbp_msg.lon;
  ros_msg.height = sbp_msg.height;
...
MsgVelEcefGnss convertSbpMsgToRosMsg(const msg_vel_ecef_gnss_t& sbp_msg, const uint8_t len)
{
  MsgVelEcefGnss ros_msg;
  ros_msg.tow = sbp_msg.tow;
  ros_msg.x = sbp_msg.x;
  ros_msg.y = sbp_msg.y;
  ros_msg.z = sbp_msg.z;
...
MsgVelEcefCovGnss convertSbpMsgToRosMsg(const msg_vel_ecef_cov_gnss_t& sbp_msg, const uint8_t len)
{
  MsgVelEcefCovGnss ros_msg;
  ros_msg.tow = sbp_msg.tow;
  ros_msg.x = sbp_msg.x;
  ros_msg.y = sbp_msg.y;
  ros_msg.z = sbp_msg.z;
...
MsgVelNedGnss convertSbpMsgToRosMsg(const msg_vel_ned_gnss_t& sbp_msg, const uint8_t len)
{
  MsgVelNedGnss ros_msg;
  ros_msg.tow = sbp_msg.tow;
  ros_msg.n = sbp_msg.n;
  ros_msg.e = sbp_msg.e;
  ros_msg.d = sbp_msg.d;
...
MsgVelNedCovGnss convertSbpMsgToRosMsg(const msg_vel_ned_cov_gnss_t& sbp_msg, const uint8_t len)
{
  MsgVelNedCovGnss ros_msg;
  ros_msg.tow = sbp_msg.tow;
  ros_msg.n = sbp_msg.n;
  ros_msg.e = sbp_msg.e;
  ros_msg.d = sbp_msg.d;
...
MsgProtectionLevel convertSbpMsgToRosMsg(const msg_protection_level_t& sbp_msg, const uint8_t len)
{
  MsgProtectionLevel ros_msg;
  ros_msg.tow = sbp_msg.tow;
  ros_msg.vpl = sbp_msg.vpl;
  ros_msg.hpl = sbp_msg.hpl;
  ros_msg.lat = sbp_msg.lat;
  ros_msg.lon = sbp_msg.lon;
  ros_msg.height = sbp_msg.height;
  ros_msg.flags = sbp_msg.flags;
...
StecHeader convertSbpMsgToRosMsg(const stec_header_t& sbp_msg, const uint8_t len)
{
  ...
  ros_msg.iod_atmo = sbp_msg.iod_atmo;
  return ros_msg;
}
...
TroposphericDelayCorrectionNoStd convertSbpMsgToRosMsg(const tropospheric_delay_correction_no_std_t& sbp_msg, const uint8_t len)
{
  TroposphericDelayCorrectionNoStd ros_msg;
...
TroposphericDelayCorrection convertSbpMsgToRosMsg(const tropospheric_delay_correction_t& sbp_msg, const uint8_t len)
{
  ...
  ros_msg.hydro = sbp_msg.hydro;
  ros_msg.wet = sbp_msg.wet;
  ros_msg.stddev = sbp_msg.stddev;
  return ros_msg;
}

StecResidualNoStd convertSbpMsgToRosMsg(const stec_residual_no_std_t& sbp_msg, const uint8_t len)
{
  StecResidualNoStd ros_msg;
  ros_msg.sv_id = convertSbpMsgToRosMsg(sbp_msg.sv_id);
...
GridElementNoStd convertSbpMsgToRosMsg(const grid_element_no_std_t& sbp_msg, const uint8_t len)
{
  GridElementNoStd ros_msg;
  ros_msg.index = sbp_msg.index;
...
MsgSsrGriddedCorrectionNoStd convertSbpMsgToRosMsg(const msg_ssr_gridded_correction_no_std_t& sbp_msg, const uint8_t len)
{
  MsgSsrGriddedCorrectionNoStd ros_msg;
  ros_msg.header = convertSbpMsgToRosMsg(sbp_msg.header);
...
MsgWheeltick convertSbpMsgToRosMsg(const msg_wheeltick_t& sbp_msg, const uint8_t len)
{
  MsgWheeltick ros_msg;
  ros_msg.time = sbp_msg.time;
  ros_msg.flags = sbp_msg.flags;
  ros_msg.source = sbp_msg.source;
  ros_msg.ticks = sbp_msg.ticks;
  return ros_msg;
}
